      ...
      <div>
        ...
        <div className='iconRow'>
          <span className='iconSvg' aria-label='linkedin'>
            <svg viewBox='0 0 54 54'>
              <circle cx='27' cy='27' r='26'></circle>
              <path d='M19 20h3v2.5c.6-1.1 2.1-2.5 4.1-2.5 4.4 0 5.2 2.9 5.2 6.7V34h-3v-6.1c0-1.5 0-3.4-2.1-3.4-2.1 0-2.4 1.6-2.4 3.3V34h-3V20zm-5 0h3v14h-3V20zm1.5-4c1 0 1.5.7 1.5 1.5S16.5 19 15.5 19 14 18.3 14 17.5 14.5 16 15.5 16z'></path>
            </svg>
          </span>
          <span className='icoTxt'>
            <a
