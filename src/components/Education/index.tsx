                  ...
                  <div className="clearfix doc-item">
                    ...
                    <div className="singlecolumn">
                      <span className="paddedline degreeGap txtBold">
                        ...
                        <span className="programline" id={`FIELD_STUY_${index}`}></span>
                      </span>
                      <div className="paddedline">
                        <span className="companyname" id={`FIELD_SCHO_${index}`}>
                          {edu.school}
                        </span>
                        <span> - </span>
                        <span className="joblocation jobcity" id={`FIELD_SCIT_${index}`}>
                          {edu.city}
                        </span>
                        <span className="joblocation jobstate" id={`FIELD_SSTA_${index}`}></span>
                      </div>
